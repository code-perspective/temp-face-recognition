#!/usr/bin/env python3
"""
client_preprocess_input.py — Stage 5: Face detection, alignment, patch extraction.

Called by harness as: ./client_preprocess_input <size>
...
def main():
    if len(sys.argv) < 2:
        print("Usage: client_preprocess_input <size>", flush=True)
        sys.exit(1)
    ...
    print(f"[client_preprocess_input] Loading face detector...", flush=True)
    detector = load_detector()
    print(f"[client_preprocess_input] Processing pairs...", flush=True)
